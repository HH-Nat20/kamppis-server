    ...
    fun insertMockUserProfilesToDatabase(
        ...
        val userProfiles1 = listOf(
            UserProfile(
                ...
                bio =
                    "I'm a passionate traveler who loves exploring new cultures and cuisines. When I'm not studying, you can find me hiking in nature or experimenting with new recipes in the kitchen."
            },
            UserProfile(
        ...
        val userProfiles2 = listOf(
            UserProfile(
                ...
                cleanliness = Cleanliness.SPOTLESS,
                lifestyle = mutableListOf(Lifestyle.EARLY_BIRD, Lifestyle.WORKING)
            ).apply {
        ...
        profileRepository.saveAll(userProfiles1 + userProfiles2)
    }
}