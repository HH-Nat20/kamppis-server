...
class MockSwipesConfig {
    ...
    fun insertMockSwipesToDatabase(
        ...
        val userToRoomSwipes = listOf(
            ...
            Swipe(profileRepository.findById(29L).get(), profileRepository.findById(79L).get(), true),
            Swipe(profileRepository.findById(30L).get(), profileRepository.findById(79L).get(), true),
            Swipe(profileRepository.findById(27L).get(), profileRepository.findById(80L).get(), true),
            Swipe(profileRepository.findById(29L).get(), profileRepository.findById(80L).get(), true),
            Swipe(profileRepository.findById(30L).get(), profileRepository.findById(80L).get(), true),

            Swipe(profileRepository.findById(28L).get(), profileRepository.findById(81L).get(), true),
            Swipe(profileRepository.findById(31L).get(), profileRepository.findById(81L).get(), true),
            Swipe(profileRepository.findById(30L).get(), profileRepository.findById(82L).get(), true),
            Swipe(profileRepository.findById(29L).get(), profileRepository.findById(82L).get(), true),
        )
